*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSA01VEN
*   generation date: 2022.07.28 at 10:10:12
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSA01VEN           .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSA01VEN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSA01VEN_EXTRACT
TOTAL = ZVSA01VEN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSA01VEN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSA01VEN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSA01VEN_EXTRACT
TOTAL = ZVSA01VEN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSA01VEN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSA01VEN'
...
TOTAL = ZVSA01VEN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSA01VEN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSA01VEN-UPD_FLAG NE SPACE.
